...
function parsePayload(value: unknown): NotificationEventPayload {
  ...
  const stringFields: Record<NotificationType, readonly string[]> = {
    ...
    LISTING_FAVORITED_AGGREGATE: ["listingId", "listingTitle", "sourceTimestamp", "sourceId", "sourceVersion"], REVIEW_RECEIVED: ["reviewId", "reviewerId", "reviewerName", "listingId", "listingTitle"],
