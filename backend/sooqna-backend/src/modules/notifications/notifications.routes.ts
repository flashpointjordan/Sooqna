...
import { createNotificationStreamHandler, deleteNotification, getNotificationPreferences, getUnreadCount, getUnreadCounts, listNotifications, markAllNotificationsRead, markNotificationRead, streamNotifications, updateNotificationPreferences } from "./notifications.controller";
import { NotificationBroker } from "./notifications.broker";
import { createRateLimitHandler } from "../../middleware/rateLimitHandler";

const productionController = { listNotifications, getUnreadCount, getUnreadCounts, markNotificationRead, markAllNotificationsRead, deleteNotification, getNotificationPreferences, updateNotificationPreferences };
